...
public class TestCacheFileSystemAccessOperations
{
    ...
    void setUp()
    {
        ...
        InMemoryBlobCacheConfig configuration = new InMemoryBlobCacheConfig()
                .setCacheTtl(new Duration(24, HOURS));
        fileSystem = new CacheFileSystem(tracingFileSystemFactory.create(TestingConnectorSession.SESSION), new InMemoryBlobCache(configuration), new DefaultCacheKeyProvider());
    }
