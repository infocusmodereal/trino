...
public class AlluxioBlobCache
{
    ...
    @Inject
    public AlluxioBlobCache(AlluxioBlobCacheConfig config)
            throws IOException
    {
    ...
    public BlobSource get(CacheKey key, BlobSource source, Tracer tracer, AlluxioCacheStats statistics)
            throws IOException
    {
